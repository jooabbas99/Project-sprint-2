...
void isCardExpiredTest(void) {
    ...
    strcpy(cardData_test.cardExpirationDate, cardDate_test_1);
    ...
    strcpy(cardData_test.cardExpirationDate, cardDate_test_2);
    ...
    strcpy(cardData_test.cardExpirationDate, cardDate_test_3);
    ...
    strcpy(cardData_test.cardExpirationDate, cardDate_test_4);
