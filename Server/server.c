...
EN_serverError_t saveTransaction(ST_transaction_t *transData)
{
    ...
    {
        strncpy(transaction[Inc_Number].cardHolderData.cardExpirationDate , transData->cardHolderData.cardExpirationDate,sizeof(transData->cardHolderData.cardExpirationDate));
        strncpy(transaction[Inc_Number].cardHolderData.cardHolderName , transData->cardHolderData.cardHolderName,sizeof(transData->cardHolderData.cardHolderName));
...
void isValidAccountTest(void)
{
    ...
    uint32_t result;
    strcpy(test.primaryAccountNumber,"1234");
...
void saveTransactionTest(void)
{
    ...
    strcpy(transactionTest.cardHolderData.cardHolderName,"hazem ashraf");
    strcpy(transactionTest.cardHolderData.cardExpirationDate,"05/25");
    strcpy(transactionTest.cardHolderData.primaryAccountNumber,"7894561231234568");
    transactionTest.terminalData.maxTransAmount=5000;
    transactionTest.terminalData.transAmount=8500;
    strcpy(transactionTest.terminalData.transactionDate,"31/3/2023");
...
void recieveTransactionDataTest(void)
{
    ...
    strcpy(transactionTest.cardHolderData.cardHolderName,"hazem ashraf");
    strcpy(transactionTest.cardHolderData.cardExpirationDate,"05/25");
    strcpy(transactionTest.cardHolderData.primaryAccountNumber,"9856874521563250");
    strcpy(transactionTest.terminalData.transactionDate,"31/3/2023");
    transactionTest.terminalData.maxTransAmount=5000;
    ...
    strcpy(transactionTest.cardHolderData.cardHolderName,"hazem ashraf");
    strcpy(transactionTest.cardHolderData.cardExpirationDate,"05/25");
    strcpy(transactionTest.cardHolderData.primaryAccountNumber,"8989374615436850");
    strcpy(transactionTest.terminalData.transactionDate,"31/3/2023");
    transactionTest.terminalData.maxTransAmount=5000;
